...
const products = [
  {
    id: 1,
    name: "Luminária pública Plus IP66",
    image: produto1,
    description: "Iluminação pública de alta performance com proteção IP66",
    features: ["Alta durabilidade", "Proteção IP66", "LED eficiente"],
  },
  {
    id: 2,
    name: "Luminária pública Evolution IP66",
    image: produto2,
    description: "Design evolutivo para iluminação urbana moderna",
    features: ["Design inovador", "Proteção IP66", "Alto desempenho"],
  },
  {
    id: 3,
    name: "Luminária High Bay Pro IP66",
    image: produto3,
    description: "Solução profissional para grandes alturas e espaços industriais",
    features: ["Alta potência", "Proteção IP66", "Uso industrial"],
  },
  {
    id: 4,
    name: "Luminária High Bay Eco IP66",
    image: produto4,
    description: "Eficiência econômica para ambientes industriais",
    features: ["Economia de energia", "Proteção IP66", "Custo-benefício"],
  },
  {
    id: 5,
    ...
    features: ["49W de potência", "6500K", "100-240V"],
  },
  {
    id: 6,
    ...
    features: ["7W de potência", "6500K", "100-240V"],
  },
];
