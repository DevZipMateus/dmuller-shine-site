...
import luminariaSobreporBlackQuadrada from "@/assets/luminaria-sobrepor-black-quadrada.png";
import luminariaSobreporBlackEmbutir from "@/assets/luminaria-sobrepor-black.png";
...
const products = [
  ...
  {
    id: 12,
    name: "Luminária de Embutir (Quadrada)",
    image: luminariaEmbutirQuadrada,
  ...
  {
    id: 14,
    name: "Luminária de Embutir Linha Black",
    image: luminariaEmbutirLinhaBlack,
  ...
  {
    id: 16,
    name: "Luminária de Sobrepor Black (Quadrada)",
  ...
  {
    id: 17,
    name: "Luminária de Embutir Black (Quadrada)",
